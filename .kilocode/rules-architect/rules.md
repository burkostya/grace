...
**6. Переключение в режим Оркестратора для реализации разработки по вашим документам**
...
Такая архитектура позволяет экономить контекст и выполнять более простые задачи более быстрыми и простыми LLM. Однако Ask следует вызывать только если контекст действительно большой для изучения.
