# FILE:run_lesson_v4.py
# VERSION:1.0.0
# START_MODULE_CONTRACT:
# PURPOSE:Точка входа для запуска Gradio интерфейса урока lesson_v4.
...
# LINKS:[USES_API(8): gradio; CALLS_FUNCTION(9): lesson_v4.src.ui_controller.create_ui]
# END_MODULE_CONTRACT
#
...
import logging
from lesson_v4.src.ui_controller import create_ui
...
def main():
    """Запускает интерфейс Gradio для lesson_v4."""
    # START_BLOCK_LAUNCH_UI: [Запуск сервера]
    logger.info("[BeliefState][IMP:9][RUNNER][LAUNCH_UI][Start] Запуск Gradio сервера для lesson_v4... [VALUE]")
    try:
        demo = create_ui()
