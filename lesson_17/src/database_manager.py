# FILE:lesson_17/src/database_manager.py
# VERSION:1.0.0
# START_MODULE_CONTRACT:
# PURPOSE:Управление SQLite базой данных для Lesson_17.
# SCOPE:Сохранение и получение точек тригонометрической функции (x, y).
...
# LAST_CHANGE: [v1.0.0 - Первичное создание модуля управления БД для тригонометрической функции.]
# END_CHANGE_SUMMARY
#
# START_MODULE_MAP:
...
# COMPLEXITY_SCORE: 5
# END_CONTRACT
def save_points(df: pd.DataFrame, db_path: str = "lesson_17/app_17.db") -> bool:
    """
...
# COMPLEXITY_SCORE: 4
# END_CONTRACT
def get_points(db_path: str = "lesson_17/app_17.db") -> pd.DataFrame:
    """
