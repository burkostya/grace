# FILE:lesson_14/tests/test_ui.py
# VERSION:1.0.0
# START_MODULE_CONTRACT:
# PURPOSE:Тестирование UI контроллера для Lesson 14.
...
def test_handle_generate_data(ui_controller):
    ...
    df = ui_controller.handle_generate_data("sin", 0.0, 3.14, 50)
    # END_BLOCK_EXECUTE
...
def test_handle_draw_graph(ui_controller):
    ...
    ui_controller.handle_generate_data("cos", 0.0, 3.14, 10)
