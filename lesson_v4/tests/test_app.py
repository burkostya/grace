# FILE:lesson_v4/tests/test_app.py
# VERSION:1.0.0
# START_MODULE_CONTRACT:
# PURPOSE:Тестирование приложения lesson_v4 (Backend, CLI, UI Headless).
...
# LINKS:[USES_API(8): pytest, subprocess; READS_DATA_FROM(9): lesson_v4/config.json]
# END_MODULE_CONTRACT
#
...
import pandas as pd
import logging
from lesson_v4.src.parabola_logic import generate_parabola_points
from lesson_v4.src.ui_controller import ui_generate_handler
from lesson_v4.src.database_manager import DatabaseManager
from lesson_v4.src.config_manager import load_config
...
def test_cli_generate():
    ...
    # 1. Тест генерации
    cmd_gen = [
        "python", "-m", "lesson_v4.src.cli", "generate",
    ...
    cmd_exp = ["python", "-m", "lesson_v4.src.cli", "export-csv", "--output", export_file]
