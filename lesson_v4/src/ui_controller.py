# FILE:lesson_v4/src/ui_controller.py
# VERSION:1.0.0
...
# LINKS:[USES_API(8): gradio, plotly; WRITES_DATA_TO(9): lesson_v4/parabola.db]
# END_MODULE_CONTRACT
#
...
def create_ui():
    ...
    with gr.Blocks(title="Генератор параболы v4") as demo:
