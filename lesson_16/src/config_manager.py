# FILE:lesson_16/src/config_manager.py
# VERSION:1.0.0
# START_MODULE_CONTRACT:
# PURPOSE:Управление конфигурационным файлом config.json для Lesson_16.
...
# COMPLEXITY_SCORE: 3
# END_CONTRACT
def load_config(config_path: str = "lesson_16/config.json") -> dict:
    """
    Считывает JSON файл конфигурации. Если файл отсутствует или поврежден,
    возвращает словарь с параметрами по умолчанию. Это обеспечивает
    отказоустойчивость системы при первом запуске или ошибках ФС.
    """
...
# COMPLEXITY_SCORE: 3
# END_CONTRACT
def save_config(config: dict, config_path: str = "lesson_16/config.json") -> bool:
    """
